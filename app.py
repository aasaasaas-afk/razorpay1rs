...
PAYMENT_DATA = {
    ...
    '_[build]': '18372560617',
    '_[request_index]': '0',
    'amount': '100',  # 100 INR (~0. Pictogram
...
def razorpay_check():
    ...
    # Step 2: Cancel previous payment (optional, may not be needed)
    try:
    ...
    payment_data.update({
        ...
        'order_id': order_id,  # Use new order_id
    })
    # Remove potentially invalid fields
    payment_data.pop('currency_request_id', None)
    payment_data.pop('payment_link_id', None)
